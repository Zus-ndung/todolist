...
Internal = Code(statusCode=status.HTTP_500_INTERNAL_SERVER_ERROR, errorCode=100000)
...
DatabaseError = Code(statusCode=status.HTTP_500_INTERNAL_SERVER_ERROR, errorCode=300001)
